...
describe OmniAuth::Strategies::Globalize do
  before :each do
  ...
  subject do
    ...
    OmniAuth::Strategies::Globalize.new(nil, *args).tap do |strategy|
  ...
  describe '#client' do
    it 'has correct site' do
      subject.client.site.should eq('https://www.globalize.com')
    end
  ...
  describe '#raw_info' do
    ...
    it 'performs a GET to https://api.globalize.com/v2/account' do
      @access_token.stub(:get) { double('OAuth2::Response').as_null_object }
      @access_token.should_receive(:get).with('/v2/account')
      subject.raw_info
    end
    
    it 'returns a Hash' do
      @access_token.stub(:get).with('/v2/account') do
